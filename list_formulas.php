...
<?php
            ...
            foreach ($herbList as $herbCount => $herbData)
            {
                ...
                echo 'herbDef["'. $herbCount. '"] = ' . json_encode($individualHerbInfo[0][4]) . ';';		//description					
            }
        ...
        if (!is_null($preparationList))
        {
            ...
            foreach ($preparationList as $prepCount => $prepData)
            {
                ...
                echo 'prepDef["'. $prepCount. '"] = ' . json_encode($prepData[1]) . ';';		//description					
            }
...
<?php
    ...
    if (!is_null($formulaInfo))
    {
        ...
        {
           $list .= $formulaInfo['description']. "<br/></br>";
        }
        ...
        {
            $list .= "Preparations: " . $formulaInfo['preparations'] . "<br/>";
        }
